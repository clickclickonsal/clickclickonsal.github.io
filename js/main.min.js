...
$(document).ready(function(){smoothScroll.init(),$(window).resize(function(){$(window).width()<768?$(".nav-pills").addClass("nav-stacked"):$(".nav-pills").removeClass("nav-stacked")}),$(window).on("load",function(){$(window).width()<768&&$(".nav-pills").addClass("nav-stacked")})});